...
namespace SpssHelper
{
    ...
    public enum ReturnCode : int
    {
        ...
        /// <summary>
        /// Variable label抯 length exceeds 120, truncated and
        /// used (warning)
        /// </summary>
        SPSS_EXC_LEN120 = -2,
    ...
    public class SpssThinWrapper
    {
        ...
        /// GUID. Note that the spssOpenWriteCopy function will not copy the source file抯
        /// GUID. spssGetDEWGUID allows the client to read a file抯 GUID, if any. The client
        ...
        /// *<paramref>missingFormat</paramref> will be in the range 0?, indicating 
        ...
        /// null-terminated string. The type code is an integer in the range 0?55, 0 indicating a numeric
        ...
        /// neither of the above, it will be in the range 0?, indicating the number of discrete missing
        /// values present. (The macros SPSS_NO_MISSVAL, SPSS_ONE_MISSVAL,
        /// SPSS_TWO_MISSVAL, and SPSS_THREE_MISSVAL may be used as synonyms for 0?.)
        /// </remarks>
        ...
        /// element of the array. The type code is an integer in the range 0?55, 0 indicating a numeric
        /// variable and a positive value indicating a string variable of that size.
        ...
        /// new file initialized with a copy of the old file抯 dictionary, then <see cref="spssOpenReadDelegate"/> (oldFile-
        ...
        /// record 7, subtype 3. Its first six elements comprise the 揻ixed?information, followed
        ...
        /// missingFormat must be set to a value in the range 0? to indicate the number of missing
        ...
        /// missing value. If missingFormat is neither of the above, it must be in the range 0?,
