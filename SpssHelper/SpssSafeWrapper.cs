...
namespace SpssHelper
{
    ...
    public class SpssSafeWrapper : SpssThinWrapper
    {
        ...
        /// GUID. spssGetDEWGUID allows the client to read a file抯 GUID, if any. 
        /// </remarks>
        ...
        /// The type code is an integer in the range 0?55, 0 indicating a numeric
        ...
        /// 0?, indicating the number of discrete missing
        ...
        /// new file initialized with a copy of the old file抯 dictionary, then <see cref="spssOpenRead"/> (oldFile-
