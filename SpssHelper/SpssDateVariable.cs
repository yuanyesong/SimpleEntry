...
namespace SpssHelper
{
    ...
    public class SpssDateVariable : SpssVariable
    {
        ...
        protected override void Update()
        {
            ...
            SpssException.ThrowOnFailure(SpssSafeWrapper.spssSetVarPrintFormat(FileHandle, Name, this.PrintFormat, 0, this.PrintWidth), "spssSetVarPrintFormat");
            SpssException.ThrowOnFailure(SpssSafeWrapper.spssSetVarWriteFormat(FileHandle, Name, this.WriteFormat, 0, this.WriteWidth), "spssSetVarWriteFormat");
        }
